...
snapshots["test_dogfood_match_snapshot 1"] = GenericRepr(
    "Node(identifier='codoc.service.parsing.node.create_node_from_objectNodeType.FUNCTION', name='create_node_from_object', description='', of_type=<NodeType.FUNCTION: 2>, parent_identifier='codoc.service.parsing.codoc.service.parsing.nodeNodeType.MODULE', path='/home/cdk/dev/codoc-python/src/codoc/service/parsing/node.py', args=('obj',), lines=(14, 16))"
)
