...
snapshots["TestGetDependencyEdges.test_dogfood_match_snapshot 1"] = frozenset(
    [
        ...
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='typing.OptionalNodeType.CLASS')"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='builtins.TypeErrorNodeType.CLASS')"
        ),
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='typing.CallableNodeType.CLASS')"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='codoc.service.parsing.dependency.UnexpectedBuiltinErrorNodeType.CLASS')"
        ),
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='builtins.frozensetNodeType.CLASS')"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='codoc.service.parsing.utils.is_an_instanceNodeType.FUNCTION')"
        ),
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='codoc.service.parsing.utils.is_builtinNodeType.FUNCTION')"
        ),
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='codoc.service.parsing.dependency._get_dependency_nodesNodeType.FUNCTION')"
        ),
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='codoc.domain.model.NodeNodeType.CLASS')"
        ),
        GenericRepr(
            "Dependency(from_node='codoc.service.parsing.dependency.get_dependency_edgesNodeType.FUNCTION', to_node='codoc.service.parsing.dependency.get_module_of_objectNodeType.FUNCTION')"
        ),
    ]
)
...
snapshots["TestGetDependencyNodesAndParents.test_class_match_snapshot 1"] = frozenset(
    [
        ...
        GenericRepr(
            "Node(identifier='None.dataclassesNodeType.MODULE', name='dataclasses', description='', of_type=<NodeType.MODULE: 3>, parent_identifier=None, path='/usr/lib/python3.9/dataclasses.py', args=None, lines=(1, 1285))"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='examples.AnimalTypeNodeType.CLASS', name='AnimalType', description='An enumeration.', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path='/home/cdk/dev/codoc-python/tests/examples/__init__.py', args=('cls', 'value', 'names'), lines=(91, 95))"
        ),
        GenericRepr(
...
snapshots["TestGetDependencyNodesAndParents.test_dogfood_match_snapshot 1"] = frozenset(
    [
        GenericRepr(
            "Node(identifier='None.codocNodeType.MODULE', name='codoc', description='', of_type=<NodeType.MODULE: 3>, parent_identifier=None, path='/home/cdk/dev/codoc-python/src/codoc/__init__.py', args=None, lines=None)"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='codoc.codoc.domainNodeType.MODULE', name='codoc.domain', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='None.codocNodeType.MODULE', path='/home/cdk/dev/codoc-python/src/codoc/domain/__init__.py', args=None, lines=None)"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='codoc.service.codoc.service.parsingNodeType.MODULE', name='codoc.service.parsing', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='codoc.codoc.serviceNodeType.MODULE', path='/home/cdk/dev/codoc-python/src/codoc/service/parsing/__init__.py', args=None, lines=None)"
        ),
        GenericRepr(
            "Node(identifier='codoc.service.parsing.codoc.service.parsing.dependencyNodeType.MODULE', name='codoc.service.parsing.dependency', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='codoc.service.codoc.service.parsingNodeType.MODULE', path='/home/cdk/dev/codoc-python/src/codoc/service/parsing/dependency.py', args=None, lines=(1, 263))"
        ),
        GenericRepr(
            "Node(identifier='codoc.codoc.serviceNodeType.MODULE', name='codoc.service', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='None.codocNodeType.MODULE', path='/home/cdk/dev/codoc-python/src/codoc/service/__init__.py', args=None, lines=(1, 32))"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='codoc.domain.codoc.domain.modelNodeType.MODULE', name='codoc.domain.model', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='codoc.codoc.domainNodeType.MODULE', path='/home/cdk/dev/codoc-python/src/codoc/domain/model.py', args=None, lines=(1, 138))"
        ),
        GenericRepr(
...
snapshots["TestGetDependencyNodesAndParents.test_module_match_snapshot 1"] = frozenset(
    [
        ...
        GenericRepr(
            "Node(identifier='examples.StudentNodeType.CLASS', name='Student', description='Student(name: str, age: int, course: examples.Course)', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path='/home/cdk/dev/codoc-python/tests/examples/__init__.py', args=('self', 'name', 'age', 'course'), lines=(50, 53))"
        ),
        GenericRepr(
            "Node(identifier='typing.ListNodeType.CLASS', name='List', description='A generic version of list.', of_type=<NodeType.CLASS: 1>, parent_identifier='None.typingNodeType.MODULE', path=None, args=('self',), lines=None)"
        ),
        ...
        GenericRepr(
            "Node(identifier='examples.StringTypedClassNodeType.CLASS', name='StringTypedClass', description='', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path='/home/cdk/dev/codoc-python/tests/examples/__init__.py', args=(), lines=(40, 48))"
        ),
        GenericRepr(
            "Node(identifier='enum.autoNodeType.CLASS', name='auto', description='Instances are replaced with an appropriate value in Enum class suites.', of_type=<NodeType.CLASS: 1>, parent_identifier='None.enumNodeType.MODULE', path='/usr/lib/python3.9/enum.py', args=(), lines=(67, 72))"
        ),
        GenericRepr(
            "Node(identifier='None.enumNodeType.MODULE', name='enum', description='', of_type=<NodeType.MODULE: 3>, parent_identifier=None, path='/usr/lib/python3.9/enum.py', args=None, lines=(1, 1016))"
        ),
        GenericRepr(
            "Node(identifier='examples.BareClassNodeType.CLASS', name='BareClass', description='', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path='/home/cdk/dev/codoc-python/tests/examples/__init__.py', args=(), lines=(10, 12))"
        ),
        GenericRepr(
            "Node(identifier='None.typingNodeType.MODULE', name='typing', description='The typing module: Support for gradual typing as defined by PEP 484.\\n\\nAt large scale, the structure of the module is following:\\n* Imports and exports, all public names should be explicitly added to __all__.\\n* Internal helper functions: these should never be used in code outside this module.\\n* _SpecialForm and its instances (special forms): Any, NoReturn, ClassVar, Union, Optional\\n* Two classes whose instances can be type arguments in addition to types: ForwardRef and TypeVar\\n* The core of internal generics API: _GenericAlias and _VariadicGenericAlias, the latter is\\n  currently only used by Tuple and Callable. All subscripted types like X[int], Union[int, str],\\n  etc., are instances of either of these classes.\\n* The public counterpart of the generics API consists of two classes: Generic and Protocol.\\n* Public helper functions: get_type_hints, overload, cast, no_type_check,\\n  no_type_check_decorator.\\n* Generic aliases for collections.abc ABCs and few additional protocols.\\n* Special types: NewType, NamedTuple, TypedDict.\\n* Wrapper submodules for re and io related types.', of_type=<NodeType.MODULE: 3>, parent_identifier=None, path='/usr/lib/python3.9/typing.py', args=None, lines=(1, 2209))"
        ),
        ...
        GenericRepr(
            "Node(identifier='examples.ClassWithHackyDocumentationNodeType.CLASS', name='ClassWithHackyDocumentation', description='DescriptionDescriptionDescriptionDescriptionDescription', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path='/home/cdk/dev/codoc-python/tests/examples/__init__.py', args=(), lines=(80, 86))"
        ),
        GenericRepr(
            "Node(identifier='examples.PersonNodeType.CLASS', name='Person', description='Person is a human that has a name and an age', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path='/home/cdk/dev/codoc-python/tests/examples/__init__.py', args=('self', 'name', 'age'), lines=(18, 26))"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='examples.BareClassExtensionNodeType.CLASS', name='BareClassExtension', description='', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path='/home/cdk/dev/codoc-python/tests/examples/__init__.py', args=(), lines=(14, 16))"
        ),
        GenericRepr(
            "Node(identifier='examples.examples.submoduleNodeType.MODULE', name='examples.submodule', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='None.examplesNodeType.MODULE', path='/home/cdk/dev/codoc-python/tests/examples/submodule/__init__.py', args=None, lines=(1, 4))"
        ),
        GenericRepr(
