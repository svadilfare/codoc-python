...
snapshots["TestGetDependencyNodesAndParents.test_class_match_snapshot 1"] = frozenset(
    [
        GenericRepr(
            "Node(identifier='None.dataclassesNodeType.MODULE', name='dataclasses', description='', of_type=<NodeType.MODULE: 3>, parent_identifier=None, path=None, args=None, lines=(1, 1285))"
        ),
        GenericRepr(
            "Node(identifier='examples.AnimalTypeNodeType.CLASS', name='AnimalType', description='An enumeration.', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=('cls', 'value', 'names'), lines=(91, 95))"
        ),
        GenericRepr(
...
snapshots["TestGetDependencyNodesAndParents.test_dogfood_match_snapshot 1"] = frozenset(
    [
        GenericRepr(
            "Node(identifier='codoc.service.parsing.dependency.DependencyInspectorNodeType.CLASS', name='DependencyInspector', description='Extracts dependencies from a given class or function', of_type=<NodeType.CLASS: 1>, parent_identifier='codoc.service.parsing.codoc.service.parsing.dependencyNodeType.MODULE', path=None, args=('self', 'obj'), lines=(110, 211))"
        ),
        GenericRepr(
            "Node(identifier='codoc.codoc.serviceNodeType.MODULE', name='codoc.service', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='None.codocNodeType.MODULE', path=None, args=None, lines=(1, 32))"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='codoc.domain.codoc.domain.modelNodeType.MODULE', name='codoc.domain.model', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='codoc.codoc.domainNodeType.MODULE', path=None, args=None, lines=(1, 138))"
        ),
        GenericRepr(
            "Node(identifier='codoc.domain.model.NodeNodeType.CLASS', name='Node', description='Nodes represents a given source code item,\\ni.e a class, function or module.\\n\\nIt contains all the meta data as well as the code that\\ndefined the node in question.', of_type=<NodeType.CLASS: 1>, parent_identifier='codoc.domain.codoc.domain.modelNodeType.MODULE', path=None, args=('self', 'identifier', 'name', 'description', 'of_type', 'parent_identifier', 'path', 'args', 'lines'), lines=(16, 54))"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='codoc.service.parsing.codoc.service.parsing.dependencyNodeType.MODULE', name='codoc.service.parsing.dependency', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='codoc.service.codoc.service.parsingNodeType.MODULE', path=None, args=None, lines=(1, 263))"
        ),
    ]
)
...
snapshots["TestGetDependencyNodesAndParents.test_module_match_snapshot 1"] = frozenset(
    [
        GenericRepr(
            "Node(identifier='examples.PersonNodeType.CLASS', name='Person', description='Person is a human that has a name and an age', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=('self', 'name', 'age'), lines=(18, 26))"
        ),
        GenericRepr(
            "Node(identifier='None.enumNodeType.MODULE', name='enum', description='', of_type=<NodeType.MODULE: 3>, parent_identifier=None, path=None, args=None, lines=(1, 1016))"
        ),
        GenericRepr(
            "Node(identifier='None.typingNodeType.MODULE', name='typing', description='The typing module: Support for gradual typing as defined by PEP 484.\\n\\nAt large scale, the structure of the module is following:\\n* Imports and exports, all public names should be explicitly added to __all__.\\n* Internal helper functions: these should never be used in code outside this module.\\n* _SpecialForm and its instances (special forms): Any, NoReturn, ClassVar, Union, Optional\\n* Two classes whose instances can be type arguments in addition to types: ForwardRef and TypeVar\\n* The core of internal generics API: _GenericAlias and _VariadicGenericAlias, the latter is\\n  currently only used by Tuple and Callable. All subscripted types like X[int], Union[int, str],\\n  etc., are instances of either of these classes.\\n* The public counterpart of the generics API consists of two classes: Generic and Protocol.\\n* Public helper functions: get_type_hints, overload, cast, no_type_check,\\n  no_type_check_decorator.\\n* Generic aliases for collections.abc ABCs and few additional protocols.\\n* Special types: NewType, NamedTuple, TypedDict.\\n* Wrapper submodules for re and io related types.', of_type=<NodeType.MODULE: 3>, parent_identifier=None, path=None, args=None, lines=(1, 2209))"
        ),
        GenericRepr(
            "Node(identifier='examples.ClassWithHackyDocumentationNodeType.CLASS', name='ClassWithHackyDocumentation', description='DescriptionDescriptionDescriptionDescriptionDescription', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=(), lines=(80, 86))"
        ),
        GenericRepr(
            "Node(identifier='typing.ListNodeType.CLASS', name='List', description='A generic version of list.', of_type=<NodeType.CLASS: 1>, parent_identifier='None.typingNodeType.MODULE', path=None, args=('self',), lines=None)"
        ),
        ...
        GenericRepr(
            "Node(identifier='examples.StringTypedClassNodeType.CLASS', name='StringTypedClass', description='', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=(), lines=(40, 48))"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='examples.BareClassNodeType.CLASS', name='BareClass', description='', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=(), lines=(10, 12))"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='examples.CourseNodeType.CLASS', name='Course', description='Course contains information about a specific study direction\\nwith name, year as well as whether it is in the spring or fall', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=('self', 'name', 'year', 'spring'), lines=(28, 38))"
        ),
        GenericRepr(
            "Node(identifier='None.builtinsNodeType.MODULE', name='builtins', description=\"Built-in functions, exceptions, and other objects.\\n\\nNoteworthy: None is the `nil' object; Ellipsis represents `...' in slices.\", of_type=<NodeType.MODULE: 3>, parent_identifier=None, path=None, args=None, lines=None)"
        ),
        GenericRepr(
            "Node(identifier='examples.BareClassExtensionNodeType.CLASS', name='BareClassExtension', description='', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=(), lines=(14, 16))"
        ),
        GenericRepr(
            "Node(identifier='dataclasses.dataclassNodeType.FUNCTION', name='dataclass', description='Returns the same class as was passed in, with dunder methods\\nadded based on the fields defined in the class.\\n\\nExamines PEP 526 __annotations__ to determine fields.\\n\\nIf init is true, an __init__() method is added to the class. If\\nrepr is true, a __repr__() method is added. If order is true, rich\\ncomparison dunder methods are added. If unsafe_hash is true, a\\n__hash__() method function is added. If frozen is true, fields may\\nnot be assigned to after instance creation.', of_type=<NodeType.FUNCTION: 2>, parent_identifier='None.dataclassesNodeType.MODULE', path=None, args=('cls',), lines=(998, 1022))"
        ),
        GenericRepr(
            "Node(identifier='examples.examples.submoduleNodeType.MODULE', name='examples.submodule', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=None, lines=(1, 4))"
        ),
        GenericRepr(
            "Node(identifier='enum.EnumNodeType.CLASS', name='Enum', description='Generic enumeration.\\n\\nDerive from this class to define new enumerations.', of_type=<NodeType.CLASS: 1>, parent_identifier='None.enumNodeType.MODULE', path=None, args=('cls', 'value', 'names'), lines=(640, 767))"
        ),
        GenericRepr(
        ...
        GenericRepr(
            "Node(identifier='enum.autoNodeType.CLASS', name='auto', description='Instances are replaced with an appropriate value in Enum class suites.', of_type=<NodeType.CLASS: 1>, parent_identifier='None.enumNodeType.MODULE', path=None, args=(), lines=(67, 72))"
        ),
        GenericRepr(
            "Node(identifier='examples.StudentNodeType.CLASS', name='Student', description='Student(name: str, age: int, course: examples.Course)', of_type=<NodeType.CLASS: 1>, parent_identifier='None.examplesNodeType.MODULE', path=None, args=('self', 'name', 'age', 'course'), lines=(50, 53))"
        ),
    ]
)
