...
snapshots["test_matches_snapshot[exclude_classes] 1"] = (
    set(
        [
            ...
            GenericRepr(
                "Node(identifier='ModuleB', name='test', description='test', of_type=<NodeType.MODULE: 3>, parent_identifier=None, path=None, args=None, lines=None)"
            ),
            GenericRepr(
...
snapshots["test_matches_snapshot[exclude_functions] 1"] = (
    set(
        [
            ...
            GenericRepr(
                "Node(identifier='ClassB', name='test', description='test', of_type=<NodeType.CLASS: 1>, parent_identifier='ModuleA', path=None, args=None, lines=None)"
            ),
            GenericRepr(
