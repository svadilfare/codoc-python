...
snapshots["test_happy_path_dogfood_creates_graph 1"] = (
    set(
        [
            GenericRepr(
                "Node(identifier='codoc.domain.helpers.get_nodeNodeType.FUNCTION', name='get_node', description='', of_type=<NodeType.FUNCTION: 2>, parent_identifier='codoc.domain.codoc.domain.helpersNodeType.MODULE', path=None, args=('identifier', 'graph'), lines=(22, 27))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.model.DependencyNodeType.CLASS', name='Dependency', description=\"A Dependency shows that one node depends on another.\\nCurrently it doesn't specify the type of dependency.\", of_type=<NodeType.CLASS: 1>, parent_identifier='codoc.domain.codoc.domain.modelNodeType.MODULE', path=None, args=('self', 'from_node', 'to_node'), lines=(56, 68))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.helpers.NodeIdentifierNotFoundExceptionNodeType.CLASS', name='NodeIdentifierNotFoundException', description='Common base class for all non-exit exceptions.', of_type=<NodeType.CLASS: 1>, parent_identifier='codoc.domain.codoc.domain.helpersNodeType.MODULE', path=None, args=('self', 'identifier', 'graph'), lines=(15, 20))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.helpers.get_parent_nodeNodeType.FUNCTION', name='get_parent_node', description='', of_type=<NodeType.FUNCTION: 2>, parent_identifier='codoc.domain.codoc.domain.helpersNodeType.MODULE', path=None, args=('current_node', 'graph'), lines=(37, 44))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.helpers.ParentNotFoundExceptionNodeType.CLASS', name='ParentNotFoundException', description='Common base class for all non-exit exceptions.', of_type=<NodeType.CLASS: 1>, parent_identifier='codoc.domain.codoc.domain.helpersNodeType.MODULE', path=None, args=('self', 'current_node', 'graph'), lines=(7, 13))"
            ),
            GenericRepr(
                "Node(identifier='codoc.domain.helpers.has_childrenNodeType.FUNCTION', name='has_children', description='', of_type=<NodeType.FUNCTION: 2>, parent_identifier='codoc.domain.codoc.domain.helpersNodeType.MODULE', path=None, args=('identifier', 'graph'), lines=(29, 31))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.helpers.get_childrenNodeType.FUNCTION', name='get_children', description='', of_type=<NodeType.FUNCTION: 2>, parent_identifier='codoc.domain.codoc.domain.helpersNodeType.MODULE', path=None, args=('identifier', 'graph'), lines=(33, 35))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.model.GraphNodeType.CLASS', name='Graph', description='A Graph is the base element of the system.\\nIt contains both edges (Dependencies) as well as nodes (classes, functions, etc).\\n\\nIt supports a variety of operators.', of_type=<NodeType.CLASS: 1>, parent_identifier='codoc.domain.codoc.domain.modelNodeType.MODULE', path=None, args=('self', 'edges', 'nodes'), lines=(70, 128))"
            ),
            GenericRepr(
                "Node(identifier='codoc.domain.model.edge_is_in_nodesNodeType.FUNCTION', name='edge_is_in_nodes', description='', of_type=<NodeType.FUNCTION: 2>, parent_identifier='codoc.domain.codoc.domain.modelNodeType.MODULE', path=None, args=('edge', 'nodes'), lines=(130, 134))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.codoc.domain.helpersNodeType.MODULE', name='codoc.domain.helpers', description='', of_type=<NodeType.MODULE: 3>, parent_identifier='codoc.codoc.domainNodeType.MODULE', path=None, args=None, lines=(1, 44))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.model.identifier_is_in_nodesNodeType.FUNCTION', name='identifier_is_in_nodes', description='', of_type=<NodeType.FUNCTION: 2>, parent_identifier='codoc.domain.codoc.domain.modelNodeType.MODULE', path=None, args=('identifier', 'nodes'), lines=(136, 138))"
            ),
            GenericRepr(
            ...
            GenericRepr(
                "Node(identifier='codoc.domain.model.NodeTypeNodeType.CLASS', name='NodeType', description='An enumeration.', of_type=<NodeType.CLASS: 1>, parent_identifier='codoc.domain.codoc.domain.modelNodeType.MODULE', path=None, args=('cls', 'value', 'names'), lines=(7, 11))"
            ),
        ]
    ),
    set(
