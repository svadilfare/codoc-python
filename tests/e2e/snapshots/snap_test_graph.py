...
snapshots["test_happy_path_create_graph 1"] = (
    [
        ...
        "examples.foldermodule.test/NodeType.MODULE/examples.foldermodule",
        "examples.foldermodule/NodeType.MODULE/examples",
        "examples.non_mentioned_module/NodeType.MODULE/examples",
        ...
        "foo_one/NodeType.FUNCTION/examples.foldermodule.test",
        "foo_ten/NodeType.FUNCTION/examples.submodule.classes",
        "goat/NodeType.FUNCTION/examples.non_mentioned_module",
